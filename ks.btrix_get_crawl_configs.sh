...
# Get Crawl Configs
# durchsucht Crawl Configs über GET-Parameter
# cid Stub VG Herrstein
CID_STUB="ab0d70dd-922"
curl -XGET -H "Authorization: Bearer $TOKEN" -H "Accept: application/json" "http://$BTRIX_API_URL/orgs/$BTRIX_ORGID/crawlconfigs?description=$CID_STUB"
